...
public class ClassicalActivity extends AppCompatActivity {
    ...
    private MediaPlayer mClassical;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            ...
            mClassical = MediaPlayer.create(ClassicalActivity.this, R.raw.snowflake);
            mClassical.start();
            mClassical.setOnCompletionListener(mCompletionListener);
        }
